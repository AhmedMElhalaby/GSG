    ...
    <div class="container-login100">
        <div class="wrap-main">
            <div class="container-fluid">
                <div class="row">
                    <nav class="navbar navbar-expand-lg navbar-light  bgwhite">
                        <a class="navbar-brand ProjectColor" href="home.html">WebProject</a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto">
                                <li class="nav-item active">
                                    <a class="nav-link fs-15" href="home.html">Home <span class="sr-only">(current)</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link fs-15" href="profile.html">Profile</a>
                                </li>
                            ...
                            <div class="form-inline my-2 my-lg-0">
                                <ul class="navbar-nav mr-auto">
                                    <li class="nav-item active">
                                        <a class="nav-link fs-18" href="login.html" data-toggle="tooltip" data-placement="top" title="Log out !"><i class="fa fa-sign-out" aria-hidden="true"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="container mt-5">
                ...
                <!--<div class="create">-->
                <!--&lt;!&ndash;<div class="title "> <p class="p-1 ml-2 mt-1 fs-14 font-cairo font-weight-600">Add Post</p></div>&ndash;&gt;-->
                <!--&lt;!&ndash;<hr class="m-1">&ndash;&gt;-->
                <!--<div class="text-area pt-3">-->
                <!--<textarea name="" class="w-full p-3 fs-16 " style="height: 75px;resize: none;color: #666666;    border-radius: 5px;" placeholder="What About Today ?!"></textarea>-->
                <!--</div>-->
                <!--&lt;!&ndash;<hr class="m-1">&ndash;&gt;-->
